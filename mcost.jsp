...
<div id="contact" class="text-center">
  <div class="container">
    ...
    <div class="col-md-8 col-md-offset-2">
      <form action="mcostdb.jsp" method="post">
        <div class="row"  style="height: 400px;">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <input type="text" name="fram" class="form-control" required="required">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <input type="text" name="frsm" class="form-control" required="required">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <input type="text" name="noc" class="form-control" required="required">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="col-md-6">
          <label>Reparation Cost of 1 PS:</label>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <input type="text" name="rc" class="form-control" required="required">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="col-md-6">
          <label>Reparation Time of 1 PS:</label>
          </div>
          <div class="col-md-6">
            <div class="form-group">
