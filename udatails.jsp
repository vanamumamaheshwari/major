...
<div id="contact" class="text-center">
  <div class="container">
    <div class="section-title text-center">
      <h3>Cloud User Details</h3>
    </div>
    <div id="row" style="height: 500px; overflow: scroll;">
    <table class="comparison-table">
        <thead>
            <tr>
                <td class="marker">NAME</td>
                <td class="marker">EMAIL</td>
                <td class="marker">PASSWORD</td>
                <td class="marker">AGE</td>
                <td class="marker">GENDER</td>
                <td class="marker">ADDRESS</td>
            </tr>
        </thead>
        <%
        try{
        	...
        	while(rs.next()){
        		%>
        		<tr>
            <td class="marker"><%=rs.getString("name") %></td>
            <td class="marker"><%=rs.getString("email") %></td>
            <td class="marker"><%=rs.getString("password") %></td>
            <td class="marker"><%=rs.getString("age") %></td>
            <td class="marker"><%=rs.getString("gender") %></td>
            <td class="marker"><%=rs.getString("address") %></td>
        </tr>   
        		<%
        	}
        }
