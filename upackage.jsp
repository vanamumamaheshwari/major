  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="uupackage.jsp" class="page-scroll">User Package</a></li>
  ...
  <div class="container">
    ...
    <table class="comparison-table">
        ...
        try{
        	...
        	String sql="select upackage.id,upackage.emailid,processor,ram,harddisk,bandwidth,ip,price,status from package inner join upackage on upackage.pid=package.id";
        	PreparedStatement ps=con.prepareStatement(sql);
        	ResultSet rs=ps.executeQuery();
        	while(rs.next()){
        		%>
        		<tr>
            <td class="marker"><%=rs.getString("emailid") %></td>
