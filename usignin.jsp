...
<div id="contact" class="text-center">
  <div class="container">
    ...
    <div class="col-md-8 col-md-offset-2">
      <form action="usignindb.jsp" method="get">
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
            <span style="font-size: 18px;">Gender: </span>&nbsp&nbsp&nbsp
              <input type="radio" name="gender" value="male" style="width: 25px; height: 25px;"><span style="font-size: 18px;">Male</span>
              &nbsp&nbsp
              <input type="radio" name="gender" value="female" style="width: 25px; height: 25px;"><span style="font-size: 18px;">Female</span>
              <p class="help-block text-danger"></p>
            </div>
          </div>
        </div>
        <div class="form-group">
          <textarea name="addr" class="form-control" rows="4" placeholder="Address" required></textarea>
          <p class="help-block text-danger"></p>
        </div>
        <div id="success"></div>
